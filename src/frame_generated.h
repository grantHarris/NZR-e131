...
#ifndef FLATBUFFERS_GENERATED_FRAME_PIXELFRAME_H_
#define FLATBUFFERS_GENERATED_FRAME_PIXELFRAME_H_
...
inline flatbuffers::Offset<Frame> CreateFrameDirect(
  ...
  return PixelFrame::CreateFrame(
      _fbb,
      pixels ? _fbb.CreateVectorOfStructs<RGBPixel>(*pixels) : 0);
}

inline const PixelFrame::Frame *GetFrame(const void *buf) {
  return flatbuffers::GetRoot<PixelFrame::Frame>(buf);
}

inline const PixelFrame::Frame *GetSizePrefixedFrame(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<PixelFrame::Frame>(buf);
}

inline bool VerifyFrameBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<PixelFrame::Frame>(nullptr);
}

inline bool VerifySizePrefixedFrameBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<PixelFrame::Frame>(nullptr);
}

inline void FinishFrameBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<PixelFrame::Frame> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_FRAME_PIXELFRAME_H_
